...
!(function (t, e) {
  ...
  var Rt = {
      ...
      initContainer: function () {
        ...
        lt(a, { width: (this.containerData = e).width, height: e.height }), pt(t, A), mt(a, A);
      },
      initCanvas: function () {
          ...
          1 < r
            ...
            : 0 < r &&
              (t
                ...
                : c && ((t = h.width) < (i = h.height) * s ? (t = i * s) : (i = t / s))),
            ...
            ((c ? 0 : 1) < r
              ? ((i = n.width - o.width),
                ...
                c &&
                  ...
                  2 === r &&
                    (o.width >= n.width &&
                      ((o.minLeft = Math.min(0, i)), (o.maxLeft = Math.max(0, i))),
                    o.height >= n.height &&
                      ((o.minTop = Math.min(0, e)), (o.maxTop = Math.max(0, e))))))
              : ((o.minLeft = -o.width),
                (o.minTop = -o.height),
                (o.maxLeft = n.width),
                (o.maxTop = n.height)));
      ...
      renderCanvas: function (t, e) {
        ...
        e &&
          ...
          lt(
            this.canvas,
            rt({ width: n.width, height: n.height }, Ht({ translateX: n.left, translateY: n.top }))
          ),
          this.renderImage(t),
      ...
      renderImage: function (t) {
        ...
        rt(i, { width: a, height: n, left: (e.width - a) / 2, top: (e.height - n) / 2 }),
          lt(
            this.image,
            rt(
      ...
      initCropBox: function () {
        ...
        i && (e.height * i > e.width ? (t.height = t.width / i) : (t.width = t.height * i)),
          (this.cropBoxData = t),
      ...
      limitCropBox: function (t, e) {
        ...
        t &&
          ...
          (t = s ? Math.min(o.width, h.width, h.width + h.left, o.width - h.left) : o.width),
          (n = s ? Math.min(o.height, h.height, h.height + h.top, o.height - h.top) : o.height),
          (i = Math.min(i, o.width)),
          (a = Math.min(a, o.height)),
          c &&
            (i && a ? (i < a * c ? (a = i / c) : (i = a * c)) : i ? (a = i / c) : a && (i = a * c),
            t < n * c ? (n = t / c) : (t = n * c)),
      ...
      renderCropBox: function () {
        ...
        (i.width > i.maxWidth || i.width < i.minWidth) && (i.left = i.oldLeft),
          ...
          t.movable &&
            t.cropBoxMovable &&
            wt(this.face, g, i.width >= e.width && i.height >= e.height ? E : k),
          lt(
            this.cropBox,
            rt({ width: i.width, height: i.height }, Ht({ translateX: i.left, translateY: i.top }))
          ),
    ...
    St = {
        ...
        i && (o.crossOrigin = i),
          ...
          e &&
            ...
            ht((this.previews = o), function (t) {
              ...
              wt(t, f, { width: t.offsetWidth, height: t.offsetHeight, html: t.innerHTML }),
                i && (e.crossOrigin = i),
                (e.src = a),
                (e.alt = n),
                (e.style.cssText =
      ...
      preview: function () {
        ...
        this.cropped &&
          ...
          (lt(
            this.viewBoxImage,
            rt({ width: c, height: d }, Ht(rt({ translateX: -l, translateY: -p }, h)))
          ),
          ht(this.previews, function (t) {
            var e = vt(t, f),
              i = e.width,
    ...
    r = {
      bind: function () {
        ...
        at(e.cropstart) && Dt(t, C, e.cropstart),
          ...
          e.zoomable &&
            e.zoomOnWheel &&
            Dt(i, "wheel", (this.onWheel = this.wheel.bind(this)), { passive: !1, capture: !0 }),
          e.toggleDragModeOnDblclick && Dt(i, D, (this.onDblclick = this.dblclick.bind(this))),
          Dt(t.ownerDocument, I, (this.onCropMove = this.cropMove.bind(this))),
          Dt(t.ownerDocument, P, (this.onCropEnd = this.cropEnd.bind(this))),
          e.responsive && Dt(window, "resize", (this.onResize = this.resize.bind(this)));
      },
      unbind: function () {
        var t = this.element,
          e = this.options,
        ...
        at(e.cropstart) && Ct(t, C, e.cropstart),
          ...
          e.zoomable && e.zoomOnWheel && Ct(i, "wheel", this.onWheel, { passive: !1, capture: !0 }),
    ...
    o = {
      ...
      cropStart: function (t) {
        ...
        this.disabled ||
          ...
          (a = 1 < Object.keys(e).length && a.zoomable && a.zoomOnTouch ? W : vt(t.target, g)),
          $.test(a) &&
      ...
      cropEnd: function (t) {
        ...
        this.disabled ||
          ...
          e &&
            ...
            this.cropping &&
              ((this.cropping = !1), ut(this.dragBox, m, this.cropped && this.options.modal)),
        ...
        switch (h) {
          ...
          case X:
            if (r) {
              ...
              b(z),
                b(N),
                !(D.x <= 0) || u < s ? ((d -= D.x), (s += D.x)) : D.y <= 0 && c <= g && (w = !1),
                (D.y <= 0 && !(g < c)) || ((l -= D.y), (c += D.y));
            d < 0 && l < 0
              ? ((h = R), (c -= l = -l), (s -= d = -d))
              : d < 0
          ...
          case S:
            if (r) {
              ...
              b(L),
                b(N),
                !(D.x <= 0) || u < s ? ((d -= D.x), (s += D.x)) : 0 <= D.y && v <= m && (w = !1),
                (0 <= D.y && !(m < v)) || (l += D.y);
            d < 0 && l < 0
              ? ((h = Y), (c -= l = -l), (s -= d = -d))
              : d < 0
    ...
    At = {
      ...
      zoomTo: function (t, e, i) {
        ...
        if (0 <= (t = Number(t)) && this.ready && !this.disabled && h.zoomable) {
          (h = d * t), (l = l * t);
          if (!1 === Bt(this.element, U, { ratio: t, oldRatio: s / d, originalEvent: i }))
            return this;
          i
            ? ((t = this.pointers),
              (d = kt(this.cropper)),
      ...
      setData: function (t) {
        ...
        return (
          this.ready &&
            ...
            i.scalable &&
              (F(t.scaleX) && t.scaleX !== a.scaleX && ((a.scaleX = t.scaleX), (e = !0)),
              F(t.scaleY) && t.scaleY !== a.scaleY && ((a.scaleY = t.scaleY), (e = !0))),
      ...
      getCanvasData: function () {
        ...
        return (
          this.ready &&
            ht(["left", "top", "width", "height", "naturalWidth", "naturalHeight"], function (t) {
              i[t] = e[t];
            }),
          i
        );
        ...
        return (
          this.ready &&
            ...
            F(t.width)
              ...
              : F(t.height) && ((e.height = t.height), (e.width = t.height * i)),
            this.renderCanvas(!0)),
          this
        );
      },
      ...
      setCropBoxData: function (t) {
        ...
        return (
          this.ready &&
            ...
            F(t.top) && (a.top = t.top),
            F(t.width) && t.width !== a.width && ((e = !0), (a.width = t.width)),
            F(t.height) && t.height !== a.height && ((i = !0), (a.height = t.height)),
      ...
      getCroppedCanvas: function () {
        ...
        var e,
          ...
          h =
            ...
            (l = void 0 === (e = y.maxWidth) ? 1 / 0 : e),
            (p = void 0 === (i = y.maxHeight) ? 1 / 0 : i),
        ...
        (e = [
                ...
                i.checkOrientation && window.ArrayBuffer
                  ? Q.test(t)
                    ...
                    : ((o = new XMLHttpRequest()),
                      ...
                      i.checkCrossOrigin && Et(t) && e.crossOrigin && (t = Wt(t)),
                      o.open("GET", t, !0),
          ...
          },
          {
            ...
            value: function () {
              var t = this.element,
                ...
                i = t.crossOrigin,
                a = e;
              this.options.checkCrossOrigin && Et(e) && ((i = i || "anonymous"), (a = Wt(e))),
                (this.crossOrigin = i),
          ...
          },
          {
            ...
            value: function () {
              ...
              function e(t, e) {
                rt(i.imageData, { naturalWidth: t, naturalHeight: e, aspectRatio: t / e }),
          ...
          },
          {
            ...
            value: function () {
              ...
              this.sized &&
                ...
                pt(r, A),
                e.guides || pt(r.getElementsByClassName("".concat(c, "-dashed")), A),
                e.center || pt(r.getElementsByClassName("".concat(c, "-center")), A),
